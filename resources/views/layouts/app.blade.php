            ...
            <div class="nav-content d-flex">
                ...
                <div class="menu-container flex-grow-1">
                    <ul id="menu" class="menu">
                        ...
                        @if($user->role == 0)
                        <li>
                            <a href="{{ route('calon.informasi') }}">
                                <span class="label">Informasi Pendaftaran</span>
                            </a>
                        </li>
                        @endif
                        ...
                        @if($user->role == 1)
                        <li>
                            <a href="{{ route('siswa.ekstrakulikuler') }}">
                        ...
                        @if($user->role == 2)
                            <li>
                                <a href="{{ route('guru.ekstrakulikuler') }}">
                                    <span class="label">Kelola Ekstrakulikuler</span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if($user->role == 3)
                            <li>
                                <a href="{{ route('tatausaha.pendaftaran') }}">
                                    <span class="label">Kelola Pendaftaran</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('tatausaha.murid') }}">
                                    <span class="label">Kelola Siswa</span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if($user->role == 4)
                            ...
                            <li>
                                <a href="{{ route('admin.fasilitas') }}">
                                    <span class="label">Kelola Fasilitas</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.prestasi') }}">
                                    <span class="label">Kelola Prestasi</span>
                                </a>
                            </li>
                        @endif
                        ...
                        <li>
                            <a href="{{ route('manage.blog') }}">
                                <span class="label">Kelola Blog</span>
                            </a>
                        </li>
                        @endif
