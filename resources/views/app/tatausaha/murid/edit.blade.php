                ...
                @if ($tUser->role == 1)
                    <div class="card mb-5">
                        <div class="card-body">
                            ...
                            @if ($tUser->data)
                                <form action="{{ route('tatausaha.murid.edit.post') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="mb-3 filled form-group tooltip-end-top">
                                        ...
                                        <input value="{{ old('nisn') ?? $tUser->data->nisn }}" type="text" class="form-control" name="nisn"
                                            required />
                                        @error('nisn')
                            ...
                            @else
                                <form action="{{ route('tatausaha.murid.edit.post') }}" method="post">
                                    ...
                                    <div class="mb-3 filled form-group tooltip-end-top">
                                        <i data-acorn-icon="edit"></i>
                                        <input value="{{ old('nisn') }}" type="text" class="form-control" name="nisn"
                                            required />
                                        @error('nisn')
                                            <span class="text-danger" role="alert">
                                                {{ $message }}
